...
namespace S3BucketDemo.Controllers
{
    ...
    public class BucketController : ControllerBase
    {
        ...
        [HttpPost("copy")]
        public async Task<bool> CopyObjectInBucketAsync(string soursebucketName, string destinationbucketName, string objectName)
        {
            var request = new CopyObjectRequest
            {
                SourceBucket = soursebucketName,
